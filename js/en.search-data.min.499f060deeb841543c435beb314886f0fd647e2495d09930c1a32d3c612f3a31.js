"use strict";(function(){const t={};t.doc={id:"id",field:["title","content"],store:["title","href"]};const e=FlexSearch.create(t);window.geekdocSearchIndex=e,e.add({id:0,href:"/bits-pieces/java/spring-boot-micrometer/",title:"Spring Boot 使用 Micrometer 集成 Prometheus 监控",content:`Moved To： https://www.xlabs.club/docs/guides/spring-boot-micrometer/。
`}),e.add({id:1,href:"/bits-pieces/kubernetes/pid/",title:"容器进程数限制",content:`问题描述：
